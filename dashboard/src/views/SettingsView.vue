<template>
  <div>
    ...
    <div class="glass-card">
      ...
      <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 24px;">
        Voer een geautomatiseerde update uit naar de nieuwste Amnion 2.0 release, of herstel een eerdere werkende staat via een tarball rollback.
      </p>
